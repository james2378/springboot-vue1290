<template>
  <div :style='{"width":"68%","padding":"80px 0","margin":"10px auto","position":"relative","background":"transparent"}'>
    <div class="section-title" :style='{"margin":"10px 0 0","color":"#fff","textAlign":"center","background":"#000","width":"100%","fontSize":"20px","lineHeight":"2"}'>确认{{totalPrice>0?'下单':'预订'}}</div>
